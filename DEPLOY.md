...
يستجب — فلا يتحول الموقع إلى وضع حي على خادم معطّل.

للعودة إلى الوضع التجريبي: احذف المتغيّر `API_URL` من GitHub **و** من إعدادات
مشروع Vercel. (الـworkflow لا يمسح المتغيّر من Vercel تلقائيًا حتى لا يُلغي
قيمة ضُبطت يدويًا هناك.)
